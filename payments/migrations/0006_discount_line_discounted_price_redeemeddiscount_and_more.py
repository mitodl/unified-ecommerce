    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_users', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='discounts', to=settings.AUTH_USER_MODEL)),
                ('integrated_system', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='discounts', to='system_meta.integratedsystem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('discount', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='redeemed_discounts', to='payments.discount')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='redeemed_discounts', to='payments.order')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='redeemed_discounts', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
