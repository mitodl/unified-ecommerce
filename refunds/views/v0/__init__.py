...
from refunds.serializers.v0 import RequestLineSerializer, RequestSerializer
...
@extend_schema(
    ...
    request=inline_serializer(
        ...
        fields={
            "order": OpenApiParameter(
                name="order",
                type=IntegerField,
                description="The order to refund.",
            ),
            "lines": OpenApiParameter(
                name="lines",
                type=ListField(child=IntegerField(), allow_empty=True),
                description="The lines to refund.",
            ),
        },
    ),
